# Generated by Django 3.0.6 on 2020-06-11 02:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Book',
            fields=[
                ('isbn', models.CharField(max_length=16, primary_key=True, serialize=False, validators=[bookflix.models.validateIsbnB])),
                ('title', models.CharField(max_length=50, verbose_name='titulo')),
                ('description', models.TextField(blank=True, null=True, verbose_name='descripcion')),
        ...
        migrations.CreateModel(
            name='BookByChapter',
            fields=[
                ('isbn', models.CharField(max_length=16, primary_key=True, serialize=False, validators=[bookflix.models.validateIsbn])),
                ('title', models.CharField(max_length=50, verbose_name='titulo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=50, verbose_name='Titulo del capítulo')),
                ('description', models.TextField(blank=True, null=True, verbose_name='Descripción del capítulo')),
                ('number', models.IntegerField(default=0, validators=[bookflix.models.legalcap], verbose_name='numero')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('up', models.DateField(default=datetime.datetime(2020, 6, 11, 2, 38, 21, 590102, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='DarDeAlta')),
                ('expirationl', models.DateField(default=datetime.datetime(2020, 6, 11, 2, 38, 21, 590138, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='DarDeBaja')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('up', models.DateField(default=datetime.datetime(2020, 6, 11, 2, 38, 21, 588552, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='DarDeAlta')),
                ('expirationl', models.DateField(default=datetime.datetime(2020, 6, 11, 2, 38, 21, 588583, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='DarDeBaja')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('up_normal', models.DateField(default=datetime.datetime(2020, 6, 11, 2, 38, 21, 587798, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='pasar a normal')),
                ('expiration_normal', models.DateField(default=datetime.datetime(2020, 6, 11, 2, 38, 21, 587828, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='expiracion normal')),
                ('up_premium', models.DateField(default=datetime.datetime(2020, 6, 11, 2, 38, 21, 587852, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='pasar a premium')),
                ('expiration_premium', models.DateField(default=datetime.datetime(2020, 6, 11, 2, 38, 21, 587875, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='expiracion premium')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('up_normal', models.DateField(default=datetime.datetime(2020, 6, 11, 2, 38, 21, 586999, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='pasar a normal')),
                ('expiration_normal', models.DateField(default=datetime.datetime(2020, 6, 11, 2, 38, 21, 587055, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='expiracion normal')),
                ('up_premium', models.DateField(default=datetime.datetime(2020, 6, 11, 2, 38, 21, 587079, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='pasar a premium')),
                ('expiration_premium', models.DateField(default=datetime.datetime(2020, 6, 11, 2, 38, 21, 587102, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='expiracion premium')),
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bookflix.Book', verbose_name='libro')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('up', models.DateField(default=datetime.datetime(2020, 6, 11, 2, 38, 21, 589402, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='DarDeAlta')),
                ('expirationl', models.DateField(default=datetime.datetime(2020, 6, 11, 2, 38, 21, 589434, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='DarDeBaja')),
