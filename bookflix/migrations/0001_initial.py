...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('isbn', models.CharField(max_length=16, unique=True, validators=[bookflix.models.validateIsbnB, bookflix.models.validateIsbnNum])),
                ('title', models.CharField(max_length=50, verbose_name='titulo')),
                ('description', models.TextField(blank=True, null=True, verbose_name='descripcion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('isbn', models.CharField(max_length=16, unique=True, validators=[bookflix.models.validateIsbn, bookflix.models.validateIsbnNum])),
                ('title', models.CharField(max_length=50, verbose_name='titulo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('up', models.DateField(default=datetime.datetime(2020, 7, 6, 15, 17, 24, 795655, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='DarDeAlta')),
                ('expirationl', models.DateField(default=datetime.datetime(2020, 7, 6, 15, 17, 24, 795686, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='DarDeBaja')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('up', models.DateField(default=datetime.datetime(2020, 7, 6, 15, 17, 24, 794252, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='DarDeAlta')),
                ('expirationl', models.DateField(default=datetime.datetime(2020, 7, 6, 15, 17, 24, 794284, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='DarDeBaja')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('up_normal', models.DateField(default=datetime.datetime(2020, 7, 6, 15, 17, 24, 793438, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='pasar a normal')),
                ('expiration_normal', models.DateField(default=datetime.datetime(2020, 7, 6, 15, 17, 24, 793471, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='expiracion normal')),
                ('up_premium', models.DateField(default=datetime.datetime(2020, 7, 6, 15, 17, 24, 793496, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='pasar a premium')),
                ('expiration_premium', models.DateField(default=datetime.datetime(2020, 7, 6, 15, 17, 24, 793523, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='expiracion premium')),
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bookflix.BookByChapter', verbose_name='libro')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('up_normal', models.DateField(default=datetime.datetime(2020, 7, 6, 15, 17, 24, 792607, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='pasar a normal')),
                ('expiration_normal', models.DateField(default=datetime.datetime(2020, 7, 6, 15, 17, 24, 792645, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='expiracion normal')),
                ('up_premium', models.DateField(default=datetime.datetime(2020, 7, 6, 15, 17, 24, 792669, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='pasar a premium')),
                ('expiration_premium', models.DateField(default=datetime.datetime(2020, 7, 6, 15, 17, 24, 792693, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='expiracion premium')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('up', models.DateField(default=datetime.datetime(2020, 7, 6, 15, 17, 24, 794960, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='DarDeAlta')),
                ('expirationl', models.DateField(default=datetime.datetime(2020, 7, 6, 15, 17, 24, 794992, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='DarDeBaja')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('isbn', models.CharField(max_length=16, unique=True, validators=[bookflix.models.validateIsbn, bookflix.models.validateIsbnNum])),
                ('book', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='bookflix.BookByChapter', verbose_name='libro')),
                ('profile', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='bookflix.Profile', verbose_name='perfil')),
            ],
            options={
