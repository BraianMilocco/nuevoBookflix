    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number', models.IntegerField(help_text='este dato es solo para ordenar las busquedas internas, sepa que si un libro tiene dos capitulos y aquí pone 10 (en vez de 1) , no afectara al libro, pero en el orden se mostrara al final', validators=[bookflix.models.numerolegal, bookflix.models.Chapter.verificar_numero], verbose_name='numero de capitulo')),
                ...
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bookflix.BookByChapter', validators=[bookflix.models.Chapter.libroLleno], verbose_name='libro')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('up', models.DateField(default=datetime.datetime(2020, 6, 17, 19, 45, 15, 876902, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='DarDeAlta')),
                ('expirationl', models.DateField(default=datetime.datetime(2020, 6, 17, 19, 45, 15, 876933, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='DarDeBaja')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('up', models.DateField(default=datetime.datetime(2020, 6, 17, 19, 45, 15, 875323, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='DarDeAlta')),
                ('expirationl', models.DateField(default=datetime.datetime(2020, 6, 17, 19, 45, 15, 875353, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='DarDeBaja')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('up_normal', models.DateField(default=datetime.datetime(2020, 6, 17, 19, 45, 15, 874554, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='pasar a normal')),
                ('expiration_normal', models.DateField(default=datetime.datetime(2020, 6, 17, 19, 45, 15, 874586, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='expiracion normal')),
                ('up_premium', models.DateField(default=datetime.datetime(2020, 6, 17, 19, 45, 15, 874608, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='pasar a premium')),
                ('expiration_premium', models.DateField(default=datetime.datetime(2020, 6, 17, 19, 45, 15, 874632, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='expiracion premium')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('up_normal', models.DateField(default=datetime.datetime(2020, 6, 17, 19, 45, 15, 873779, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='pasar a normal')),
                ('expiration_normal', models.DateField(default=datetime.datetime(2020, 6, 17, 19, 45, 15, 873815, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='expiracion normal')),
                ('up_premium', models.DateField(default=datetime.datetime(2020, 6, 17, 19, 45, 15, 873838, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='pasar a premium')),
                ('expiration_premium', models.DateField(default=datetime.datetime(2020, 6, 17, 19, 45, 15, 873860, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='expiracion premium')),
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bookflix.Book', verbose_name='libro')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('up', models.DateField(default=datetime.datetime(2020, 6, 17, 19, 45, 15, 876159, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='DarDeAlta')),
                ('expirationl', models.DateField(default=datetime.datetime(2020, 6, 17, 19, 45, 15, 876193, tzinfo=utc), validators=[bookflix.models.esCorrecto], verbose_name='DarDeBaja')),
