# Generated by Django 3.0.6 on 2020-06-09 16:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='bookflix.Book', verbose_name='libro')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publication', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bookflix.Billboard', verbose_name='publicacion')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_like', models.BooleanField(default=False, verbose_name='me gusta')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bookflix.Profile', verbose_name='autor')),
                ('comment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bookflix.Comment', verbose_name='comentario')),
            ],
            options={
